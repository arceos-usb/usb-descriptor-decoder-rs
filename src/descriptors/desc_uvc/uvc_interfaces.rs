...
#[repr(u8)]
pub enum UVCStandardVideoInterfaceClass {
    CC_Video = 0x0e,
}
...
#[allow(non_camel_case_types)]
#[repr(u8)]
pub enum UVCControlInterfaceSubclass {
...
#[allow(non_camel_case_types)]
#[repr(u8)]
pub enum UVCVSInterfaceSubclass {
    UNDEFINED = 0x00,
    INPUT_HEADER = 0x01,
    OUTPUT_HEADER = 0x02,
...
#[allow(non_camel_case_types)]
#[repr(u8)]
pub enum UVCStandardVideoInterfaceProtocols {
...
#[allow(non_camel_case_types)]
#[repr(u16)]
pub enum UVCCONTROLOutputTerminalType {
